...
• 	Divisão de arquivos: separação de grandes planilhas em arquivos menores.
• 	Integração com SQL Server: conexão e atualização de dados diretamente no banco.
• 	Automação do Instagram: execução de ações automatizadas via navegador.
